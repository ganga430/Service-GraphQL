...
export const configs: GraphQLConfiguration = {
  ci: {
    aws: {
      'us-west-2': {
        awsAPIGatewayUrl: 'https://wb0oppcu5d.execute-api.us-west-2.amazonaws.com',
        awsApplicationLoadBalancer: 'alb-qa4-api.mgmresorts.com'
      }
    },
    apigee: {
      keyValueMaps: {
        graphql: {
          gqlGatewayUrl: 'https://alb-qa4-api.mgmresorts.com/graphql'
        }
      }
    }
  },
  all: {
    environmentVariables: {
      NODE_ENV: GQLEnvironment.QA4,
      SSM_PREFIX: '/ServicesGQL/qa4',
      SSM_PARAMETERS_TO_FETCH: ssmParametersToFetch.qa4,
      AS_BASE_URL: 'https://mgm-nonprod-green.apigee.net/guestservices/as/api/'
    }
  },
  gateway: {
    environmentVariables: {
      APOLLO_GRAPH_VARIANT: GQLEnvironment.QA4
    },
    local: {
      playgroundUrl: `https://wb0oppcu5d.execute-api.us-west-2.amazonaws.com/${GQLEnvironment.QA4}/graphql`
    }
  },
  customer: {
    environmentVariables: {
  ...
  cart: {
    environmentVariables: {
      CART_SERVICE_BASE_URL: 'https://mgm-nonprod-qa4.apigee.net/shopping/v1/',
      ITINERARY_SERVICES_BASE_URL: 'https://azdeapi-dev.mgmresorts.com/service/green/v2/itinerary',
      ...
      ORDER_SERVICE_BASE_URL: 'https://mgm-nonprod-qa4.apigee.net/order/v1/',
      CONTENT_API_BASE_URL: 'https://aws-origin-test-contentapi.mgmresorts.com/content-api/v3/en/',
  ...
  'mgm-show-booking': {
    environmentVariables: {
      SHOWSHOPPING_V2_BASE_URL: 'https://mgm-nonprod-qa4.apigee.net/shopping/show/v2',
      SHOWBOOKING_V2_BASE_URL: 'https://mgm-nonprod-qa4.apigee.net/booking/show/v2',
      SHOWSHOPPING_V3_BASE_URL: 'https://mgm-nonprod-qa4.apigee.net/shopping/show/v3'
    }
  },
